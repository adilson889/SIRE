...
<p align="center">
  <img src="screenshots/dashboard.jpg" width="30%" alt="Dashboard Principal" />
  <img src="screenshots/relatorio.jpg" width="30%" alt="Relatório Semanal" />
</p>
...
* **Motor de Persistência:** SQLite para armazenamento local otimizado.
* **Arquitetura de UI:** Desenvolvido integralmente via código (**Dynamic UI Building**), eliminando a sobrecarga de inflação de XMLs estáticos em componentes complexos como o relatório semanal.
* **Lógica de Negócio:** Algoritmo proprietário para processamento de calendários dinâmicos e agrupamento de dados por semana financeira.
* **Interface:** Design de alto contraste (Red/White) para legibilidade máxima em qualquer ambiente.
...
* **Relatórios Inteligentes:** Grids semanais que permitem identificar padrões de gastos e acumulação de capital ao longo do mês.
...
4.  Certifique-se de que a opção **"Instalar de Fontes Desconhecidas"** está ativa nas definições do sistema.
